...
function adminRoutes(app, bot) {
  ...
  app.get("/admin", async (req, res) => {
    ...
    const deliveredOrders = orders.filter(
      o => (o.status || "").includes("Yetkazildi")
    );
...
<div class="stats">
  ...
  <div class="stat">
    <div class="statTitle">💰 Revenue</div>
    <div class="statValue">
      ${money(revenue)} so‘m
    </div>
  </div>
  ...
  <div class="stat">
    <div class="statTitle">📦 Bugungi order</div>
    <div class="statValue">
      ${todayOrders.length}
    </div>
  </div>
  ...
  <div class="stat">
    <div class="statTitle">🚗 Aktiv order</div>
    <div class="statValue">
      ${activeOrders.length}
    </div>
  </div>
...
${orders.reverse().map(order => {
  ...
  <div class="card" id="card-${order.orderId}">
    ...
    <div class="actions">
      ...
      <button
        class="btn accept"
        onclick="setStatus('${order.orderId}','accepted')"
      >
        ✅ Qabul
      </button>
      ...
      <button
        class="btn cooking"
        onclick="setStatus('${order.orderId}','cooking')"
      >
        👨‍🍳 Tayyorlanmoqda
      </button>
      ...
      <button
        class="btn delivery"
        onclick="setStatus('${order.orderId}','delivery')"
      >
        🚗 Yo‘lda
      </button>
      ...
      <button
        class="btn done"
        onclick="setStatus('${order.orderId}','delivered')"
      >
        🎉 Yetkazildi
      </button>
      ...
      <button
        class="btn cancel"
        onclick="setStatus('${order.orderId}','cancelled')"
      >
        ❌ Bekor qilish
      </button>
