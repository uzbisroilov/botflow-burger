...
function openRestaurant(bot, chatId, restaurantId, table = null) {
...
💳 To‘lov turini tanlang:`,
    ...
    try {
      ...
      return bot.sendMessage(chatId, "Buyurtma berish uchun 📋 Menu ni bosing yoki 🏪 Restoran tanlang.");
    }
  });
